...
class CustomDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        if stage == 'test' or stage is None:
            test_dataset = load_from_disk('/content/moppit/test/correct_pepnn_biolip_test')
...
def main():
    ...
    train_dataset = load_from_disk('/content/moppit/train/correct_pepnn_biolip_train')
    val_dataset = load_from_disk('/content/moppit/val/correct_pepnn_biolip_val')
    tokenizer = AutoTokenizer.from_pretrained("facebook/esm2_t33_650M_UR50D")
